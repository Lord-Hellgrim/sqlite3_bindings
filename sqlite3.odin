...
foreign import lib "sqlite3.lib"
...
foreign lib {
	...
	*/
	...
	sqlite3_column_text    :: proc(_: ^sqlite3_stmt, iCol: i32) -> cstring ---
...
SQLITE_STATIC      := transmute(sqlite3_destructor_type)uintptr(0)
SQLITE_TRANSIENT   := transmute(sqlite3_destructor_type)(max(uintptr))
